Session.setDefault("gameShowed", undefined);
Session.setDefault('ticketBoughtByUser', undefined);
var locale_var = 'de';
...
Template.event_registration.onCreated(function() {
  var self = this;
  ...
  Session.set('backUrl', '/event_registration'); // outside a game, user get's always back to event_registration
});

Template.event_registration.onRendered(function () {
  // $('.sidenav').sidenav();  // should work from subtemplate side_nav
  $('select').formSelect();
});

Template.event_registration.helpers({
  userData: function()
  {
...
Template.event_registration.events({
...
Template.event_registration.rendered = function () {
